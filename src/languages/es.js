const es = {
  ...
  aboutSection: {
    ...
    p1: "Hola, mi nombre es Agustín y soy un entusiasta Cloud ",
    span1: "ambicioso",
    span2: " motivado",
    and: "y",
    span3: " proactivo",
    p2: ". Viviendo actualmente en La Plata, Buenos Aires, Argentina.",
    p3: "Actualmente estudiando Cloud Administration en Teclab. Me gradué como Desarrollador Web Fullstack en Digital House Coding School en 2020. Estudié Licenciatura en Informática durante dos años en la UNLP. Soy AWS Cloud Practitioner, persiguiendo más certificaciones Cloud. Poseo 20x certificaciones de HubSpot incluyendo HubSpot Certified Trainer, Architecture I & II y Revenue Operations Certified. Tengo nivel de inglés B2 upper intermediate, Español nativo y Francés básico. ",
    p4: "Soy RevOps Lead en PropHero, lidero el equipo de revenue y utilizo herramientas como HubSpot, AirTable, n8n, Zapier, entre otras integraciones para automatizar y optimizar procesos. Aporto valor aplicando mi conocimiento técnico, de desarrollo e infraestructura.",
  ...
  projectsSection: {
    ...
    lemon: {
      description:
        "Proyecto web de restaurante hecho en React para la certificación de Meta Frontend Professional Certification.",
    },
    moviefinder: {
      description:
